...
> **Status: stable.** Tagged `v2.7.0` (see [CHANGELOG](CHANGELOG.md)) and actively developed.
...
- Tagged `v2.7.0`. The published Debian package is GPG-signed; verify the signature and checksum
...
gpg --verify microide_2.7.0_amd64.deb.asc microide_2.7.0_amd64.deb
sha256sum -c microide_2.7.0_amd64.deb.sha256
```
