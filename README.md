...
> **Status: stable.** Tagged `v2.11.1` (see [CHANGELOG](CHANGELOG.md)) and actively developed.
...
- Tagged `v2.11.1`. The published Debian package is GPG-signed; verify the signature and checksum
...
sha256sum -c microide_2.11.1_amd64.deb.sha256
```
