...
> **Status: stable.** Tagged `v2.5.2` (see [CHANGELOG](CHANGELOG.md)) and actively developed.
...
- Tagged `v2.5.2`. The published Debian package is GPG-signed; verify the signature and checksum
...
gpg --verify microide_2.5.2_amd64.deb.asc microide_2.5.2_amd64.deb
sha256sum -c microide_2.5.2_amd64.deb.sha256
```
