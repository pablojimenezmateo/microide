...
> **Status: stable.** Tagged `v2.0.0` (see [CHANGELOG](CHANGELOG.md)) and actively developed.
...
- Tagged `v2.0.0`. No signed binaries are published yet; the supported paths today are: build from
