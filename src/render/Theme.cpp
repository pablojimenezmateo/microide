...
Theme MakeDefaultTheme() {
  Theme theme{
      ...
      .chrome_text = SDL_Color{0xd7, 0xde, 0xea, 0xff},
      .chrome_active_text = SDL_Color{0xf8, 0xfb, 0xff, 0xff},
      .chrome_text_secondary = SDL_Color{0xa8, 0xb4, 0xc5, 0xff},
      .surface_background = SDL_Color{0x12, 0x17, 0x22, 0xff},
      .surface_raised = SDL_Color{0x1a, 0x21, 0x30, 0xff},
      .surface_text = SDL_Color{0xd7, 0xde, 0xea, 0xff},
      .editor_background = SDL_Color{0x0f, 0x13, 0x1b, 0xff},
      .gutter_background = SDL_Color{0x0c, 0x10, 0x17, 0xff},
      .overlay_background = SDL_Color{0x1a, 0x21, 0x30, 0xf6},
      .overlay_backdrop = SDL_Color{0x05, 0x07, 0x0c, 0xaa},
      .border = SDL_Color{0x2a, 0x35, 0x48, 0xff},
      .accent = SDL_Color{0x72, 0x9e, 0xd8, 0xff},
      .text_primary = SDL_Color{0xd7, 0xde, 0xea, 0xff},
      .text_secondary = SDL_Color{0xae, 0xb9, 0xc8, 0xff},
      .text_muted = SDL_Color{0x8b, 0x98, 0xab, 0xff},
      .text_disabled = SDL_Color{0x65, 0x73, 0x86, 0xff},
      .row_highlight = SDL_Color{0x17, 0x1f, 0x2b, 0xff},
      .selection_fill = SDL_Color{0x29, 0x4f, 0x73, 0xa8},
      .search_match = SDL_Color{0x3a, 0x43, 0x5d, 0x68},
      .search_match_active = SDL_Color{0x55, 0x68, 0x91, 0x92},
      .bracket_match_background = SDL_Color{0x34, 0x54, 0x73, 0x8c},
      .cursor = SDL_Color{0xf8, 0xfb, 0xff, 0xff},
      .syntax_keyword = SDL_Color{0xff, 0x7a, 0xa2, 0xff},
      .syntax_type = SDL_Color{0x7c, 0xc7, 0xff, 0xff},
      .syntax_string = SDL_Color{0xb5, 0xd8, 0x89, 0xff},
      .syntax_comment = SDL_Color{0x8f, 0x9d, 0xb3, 0xff},
      .syntax_number = SDL_Color{0xe4, 0xb7, 0x7b, 0xff},
      .syntax_constant = SDL_Color{0xcb, 0xa6, 0xff, 0xff},
      .syntax_preprocessor = SDL_Color{0xef, 0xc5, 0x67, 0xff},
      .syntax_operator = SDL_Color{0x8e, 0xd4, 0xe6, 0xff},
      .line_number = SDL_Color{0x64, 0x72, 0x87, 0xff},
      .current_line_number = SDL_Color{0xb9, 0xc3, 0xd3, 0xff},
      .diff_added = SDL_Color{0x66, 0xb0, 0x74, 0xff},
      .diff_modified = SDL_Color{0xc2, 0x99, 0x5f, 0xff},
      .diff_deleted = SDL_Color{0xcd, 0x7a, 0x82, 0xff},
      .diagnostic_error = SDL_Color{0xff, 0x7b, 0x86, 0xff},
      ...
      .breakpoint_conditional = SDL_Color{0xe8, 0xc4, 0x4c, 0xff},
