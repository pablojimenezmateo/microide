...
Theme MakeDefaultTheme() {
  return Theme{
      ...
      .chrome_active = SDL_Color{0x20, 0x28, 0x38, 0xff},
      ...
      .accent = SDL_Color{0x7a, 0xb0, 0xff, 0xff},
      ...
      .row_highlight = SDL_Color{0x18, 0x21, 0x30, 0xff},
      ...
      .diff_added = SDL_Color{0x69, 0xc0, 0x7b, 0xff},
      .diff_modified = SDL_Color{0xd4, 0xa7, 0x5d, 0xff},
      .diff_deleted = SDL_Color{0xe0, 0x79, 0x81, 0xff},
