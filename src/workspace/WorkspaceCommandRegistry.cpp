...
std::span<const ActionSpec> WorkspaceCommandSpecs() {
  static const auto kSpecs = std::to_array<ActionSpec>({
      ...
      ActionSpec{ActionId::DetachTabToNewWindow, "detach-tab", "detach-tab",
                 "Move Tab to New Window", ""},
      ActionSpec{ActionId::DetachProjectToNewWindow, "detach-project", "detach-project",
                 "Move Project to New Window", ""},
      ActionSpec{ActionId::AcceptTabHandoff, "accept-tab-handoff", "accept-tab-handoff <file>",
                 "Accept Tab Handoff", ""},
