...
std::span<const ActionSpec> WorkspaceCommandSpecs() {
  static const auto kSpecs = std::to_array<ActionSpec>({
      ...
      ActionSpec{ActionId::GoToNextDiagnostic, "next-diagnostic", "next-diagnostic",
                 "Next Problem", "Alt+F8"},
      ActionSpec{ActionId::GoToPreviousDiagnostic, "previous-diagnostic", "previous-diagnostic",
      ...
      ActionSpec{ActionId::FindNext, "find-next", "find-next", "Find Next", "F3"},
      ActionSpec{ActionId::FindPrevious, "find-previous", "find-previous", "Find Previous",
                 "Shift+F3"},
      ...
      ActionSpec{ActionId::FocusEditorGroupLeft, "focus-group-left", "focus-group-left",
                 "Focus Left Editor Group", "Ctrl+K Ctrl+Left"},
      ActionSpec{ActionId::FocusEditorGroupRight, "focus-group-right", "focus-group-right",
                 "Focus Right Editor Group", "Ctrl+K Ctrl+Right"},
      ActionSpec{ActionId::FocusEditorGroupUp, "focus-group-up", "focus-group-up",
                 "Focus Editor Group Above", "Ctrl+K Ctrl+Up"},
      ActionSpec{ActionId::FocusEditorGroupDown, "focus-group-down", "focus-group-down",
                 "Focus Editor Group Below", "Ctrl+K Ctrl+Down"},
      ActionSpec{ActionId::MoveEditorGroupLeft, "move-group-left", "move-group-left",
                 "Move Editor Group Left", "Ctrl+K Ctrl+Shift+Left"},
      ActionSpec{ActionId::MoveEditorGroupRight, "move-group-right", "move-group-right",
                 "Move Editor Group Right", "Ctrl+K Ctrl+Shift+Right"},
      ActionSpec{ActionId::MoveEditorGroupUp, "move-group-up", "move-group-up",
                 "Move Editor Group Up", "Ctrl+K Ctrl+Shift+Up"},
      ActionSpec{ActionId::MoveEditorGroupDown, "move-group-down", "move-group-down",
                 "Move Editor Group Down", "Ctrl+K Ctrl+Shift+Down"},
      ...
      ActionSpec{ActionId::MoveLineDown, "move-line-down", "move-line-down", "Move Line Down",
                 "Alt+Down"},
      ActionSpec{ActionId::DuplicateLine, "copy-line-down", "copy-line-down",
                 "Copy Line Down", "Shift+Alt+Down"},
      ActionSpec{ActionId::CopyLineUp, "copy-line-up", "copy-line-up", "Copy Line Up",
                 "Shift+Alt+Up"},
      ActionSpec{ActionId::InsertLineBelow, "insert-line-below", "insert-line-below",
                 "Insert Line Below", "Ctrl+Enter"},
      ActionSpec{ActionId::InsertLineAbove, "insert-line-above", "insert-line-above",
      ...
      ActionSpec{ActionId::AddCursorAbove, "add-cursor-above", "add-cursor-above",
                 "Add Cursor Above", "Ctrl+Alt+Up"},
      ActionSpec{ActionId::AddCursorBelow, "add-cursor-below", "add-cursor-below",
                 "Add Cursor Below", "Ctrl+Alt+Down"},
      ActionSpec{ActionId::AddCursorsToLineEnds, "add-cursors-to-line-ends",
                 "add-cursors-to-line-ends", "Add Cursors to Line Ends", "Shift+Alt+I"},
