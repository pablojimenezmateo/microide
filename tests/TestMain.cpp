...
int main(int argc, char** argv) {
  ...
  microide::tests::RegisterDebugPaneRenderTests(tests);
  microide::tests::RegisterWorkspaceShellRenderMenusTests(tests);
  microide::tests::RegisterWorkspaceShellRenderPromptsTests(tests);
  microide::tests::RegisterEditorHoverTargetTests(tests);
  microide::tests::RegisterEditorBracketJumpTests(tests);
  ...
  microide::tests::RegisterEditorCompareSourceTests(tests);
  microide::tests::RegisterEditorGoToLineTests(tests);
  ...
  microide::tests::RegisterPluginPureHelperTests(tests);
  ...
  microide::tests::RegisterWorkspaceFileDropTests(tests);
  microide::tests::RegisterColumnSelectionTests(tests);
  ...
  microide::tests::RegisterLineIndentScanTests(tests);
  ...
  microide::tests::RegisterEditorConfigTests(tests);
  ...
  microide::tests::RegisterMultiCaretRemapTests(tests);
