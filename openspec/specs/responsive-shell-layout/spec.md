...
The user's last `ui.layout_mode` value SHALL be persisted through `PersistenceService`, observable to the new `LayoutModeService`, and exposed to the View menu and Settings overlay.
