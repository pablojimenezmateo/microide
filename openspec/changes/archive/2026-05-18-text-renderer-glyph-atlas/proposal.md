...
> full. See `dev-docs/performance/investigations/performance-bottleneck-deep-dive-4.md` →
...
`dev-docs/performance/investigations/performance-bottleneck-deep-dive-4.md` measures ~4.5 s of wall time across
