...
- Documentation: update `dev-docs/project/active-work.md`, `guidelines/ui-shell.md`, and `guidelines/host-services.md` to document the new services, the layout-mode contract, and the status-bar ownership rules.
