...
- Affected docs: `AGENTS.md`, `dev-docs/project/active-work.md`, `dev-docs/project/implementation-guide.md`, `dev-docs/project/known-tech-debt.md` (items 1–4 and 7 closed), `guidelines/architecture.md`, `guidelines/host-services.md`, `guidelines/cpp.md`, `guidelines/plugins.md`.
