...
- a PTY-backed terminal panel with tabs, scrollback, selection, clipboard paste shortcuts, alternate-screen support, application cursor-key mode, autowrap control, bracketed paste mode, and common ANSI scroll-region handling
