...
- `src/workspace/WorkspaceShell.h` is still about 1.5k lines and still defines a large amount of
  workspace state, UI state, render state, and interaction state.
